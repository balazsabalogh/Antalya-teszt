...
function bindUI(){
 ...
 longPress(logo,()=>returnHome(),()=>{clearTransientPanels();closeNotifications(true);suspendNavBanner();state.activeMenu='sonar';runSonar();openSonarMode(false)});
